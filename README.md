...
- 📚 Author of the book **"Informática: Complexidades da Computação"** (available on Amazon).
- 💻 Passionate about technology since the age of 13.
- 🎓 Studying **Software Engineering at FIAP**.
- 🚀 Currently **Lead Fullstack Developer** at STech, building **web and mobile** applications (front & back), integrations, and data architectures.
- 🤖 Actively working with **AI agents, LLMs, and automation** — from RAG pipelines to WhatsApp/CRM integrations using Claude and n8n.
- 🧠 Business-oriented mindset, focused on solution ideation, supply/demand analysis, and requirements understanding.
...
- **"Informática: Complexidades da Computação"**
  Available on [Amazon](https://www.amazon.com/dp/B09TYM7ZHM).
...
> "Pleasure in the pursuit, not the pursuit of pleasure."
